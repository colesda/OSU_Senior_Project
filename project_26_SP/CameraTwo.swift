...
class CameraTwo: UIViewController, AVCaptureFileOutputRecordingDelegate {
    ...
    override func viewDidLoad() {
        ...
        dispatch_async(sessionQueue, {
            ...
            var videoDevice: AVCaptureDevice! = CameraTwo.deviceWithMediaType(AVMediaTypeVideo, preferringPosition: AVCaptureDevicePosition.Back)
    ...
    func setup(){
        ...
        if (loopCount >= numberOfLoops) {
            timer.invalidate();
            var alert = UIAlertController(title: "Alert", message: "Go to camera roll to select images", preferredStyle: UIAlertControllerStyle.Alert)
    ...
    @IBAction func changeCamera(sender: AnyObject) {
        ...
        dispatch_async(self.sessionQueue, {
            ...
            var device:AVCaptureDevice = CameraTwo.deviceWithMediaType(AVMediaTypeVideo, preferringPosition: preferredPosition)
